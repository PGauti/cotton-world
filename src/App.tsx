...
const WhatsAppIcon = ({ size = 14, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
    <path d="M12 2a10 10 0 0 0-8.6 15.1L2 22l5-1.4A10 10 0 1 0 12 2z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    <path d="M9 10c.2 1.1.8 2.2 1.6 3 .8.8 1.9 1.4 3 1.6l1.1-.9a.5.5 0 0 1 .5-.1l1.6.5a.5.5 0 0 1 .3.5v1.5a.5.5 0 0 1-.5.5A8.5 8.5 0 0 1 8.4 8.4a.5.5 0 0 1 .5-.5H10a.5.5 0 0 1 .5.3l.5 1.6a.5.5 0 0 1-.1.5L9 10z" fill="currentColor"/>
  </svg>
);
